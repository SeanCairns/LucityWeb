...
(function (Configs, undefined)
{
    Lucity.Modules.Lucity.config(['$routeProvider', function ($routeProvider)
    {
        $routeProvider
            ...
            .when('/company', {
                templateUrl: Lucity.PartialsPath + '/company.html',
...
(function (Service, undefined)
{
    Lucity.Modules.Lucity.service("teamService", ['$http', '$q', function ($http, $q)
    {
        ...
        $http.get('resources/json/lucity_team.json').then(function (data)
        {
...
(function (Controllers, undefined)
{
    Lucity.Modules.Lucity.controller("HomePageCtrl", ['$scope', 'blogsService',
        function ($scope, blogsService)
        {
            ...
            promise.then(function (data)
            {
                $scope.blog = data.data.responseData.feed;
...
(function (Service, undefined)
{
    Lucity.Modules.Lucity.service("blogsService", ['$http', '$q', function ($http, $q)
    {
        ...
        //$http.get('http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=5&q=http://blog.lucity.com/feed/').then(function (data)
        $http.get('resources/json/LucityBlog.json').then(function (data)
        {
            deferred.resolve(data);
        });
...
(function (Service, undefined)
{
    Lucity.Modules.Lucity.service("supportService", ['$http', '$q', function ($http, $q)
    {
        var deferred = $q.defer();

        $http.get('resources/json/testimonials.json').then(function (data)
        {
            deferred.resolve(data);
        });
